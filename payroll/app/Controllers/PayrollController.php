...
class PayrollController extends Controller
{
    ...
    public function show(): void
    {
        ...
        $held       = (new \App\Repositories\SalaryHoldRepository($this->db))->activeForMonth($month);
    ...
    public function lock(): void
    {
        ...
        $month = date('Y-m-01', strtotime((string) $run['PayrollMonth']));
        $loans = new \App\Repositories\LoanRepository($this->db);
        $posted = 0;
        ...
        $holds = new \App\Repositories\SalaryHoldRepository($this->db);
        ...
        $encashPaid = (new \App\Repositories\LeaveEncashmentRepository($this->db))
