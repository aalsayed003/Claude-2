...
use App\Core\Auth;
use App\Roster\Services\XlsxWriter;
use App\Roster\Services\SpreadsheetReader;
use App\Roster\Repositories\EmployeeRepository;
use App\Roster\Repositories\DepartmentRepository;
use App\Roster\Repositories\ShiftRepository;
...
class RosterController extends Controller
{
    ...
    private function saveLegacy(int $empId, string $period, array $map): void
    {
        ...
        $byId = [];
        foreach ((new \App\Roster\Repositories\ShiftRepository($this->db))->all() as $s) {
            $byId[(int) $s['id']] = $s;
        }
