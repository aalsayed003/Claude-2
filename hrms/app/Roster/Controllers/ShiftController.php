...
class ShiftController extends Controller
{
    public function index(): void
    {
        ...
        if (legacy_mode()) {
            ...
            $shifts = (new \App\Roster\Repositories\ShiftRepository($this->db))->all(false, true);
    ...
    public function edit(): void
    {
        ...
        $shift = legacy_mode()
            ? (new \App\Roster\Repositories\ShiftRepository($this->db))->find($id)
    ...
    public function delete(): void
    {
        ...
        if (legacy_mode()) {
            $shift = (new \App\Roster\Repositories\ShiftRepository($this->db))->find($id);
            if (!$shift) {
                $this->flash('error', 'Shift not found.');
                $this->redirect('shifts');
            }
